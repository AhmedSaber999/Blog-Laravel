                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/editPost" enctype = "multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" value="{{$post->post_title}}" class="form-control @error('title') is-invalid @enderror" name="title" required autocomplete="title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="body" type="text"  class="form-control @error('title') is-invalid @enderror" name="body" required autocomplete="body">{{$post->post_body}}</textarea>    
                                @error('title')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
